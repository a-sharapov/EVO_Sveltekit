...
<head>
    ...
    <script type="text/javascript">
        ...
        var modx = {
            ...
            user: {
                ...
                groups: <?php echo json_encode($modx->getUserDocGroups()); ?>
    ...
    <script src="<?php echo e(ManagerTheme::getThemeUrl()); ?>js/modx.min.js?v=<?php echo e(ManagerTheme::getCore()->getVersionData('version')); ?>"></script>
    <?php if($modx->getConfig('show_picker')): ?>
